...
public class SubProblem {
	...
	public static String path = "../data/EqColoring/";
	...
	public ColorClass[] solvePool(String fileName, int _n, double precision, double beta, boolean[][] adjacency,
		...
		int h, k, s = 0;
		String varName, path = "../data/EqColoring/results/" + fileName;
		ColorClass[] colorClasses = null;

		// this.qModel.write(path + "/model_subProblem_" + pbNo + "_" + nrH + ".lp");
		// this.qModel.write(path + "/model_subProblem_" + pbNo + "_" + nrH + ".sol");
		...
		for (int l = 0; l < sol_count; l++) {// compute the number of valid solutions
			...
			if (_subproblemVerbosity == 1)
				System.out.println("Solution " + l + " objective value: " + this.qModel.get(DoubleAttr.PoolObjVal));
